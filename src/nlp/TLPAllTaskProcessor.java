...
public class TLPAllTaskProcessor {
	...
	public String process(String originalStr) throws IOException {
		...
		String urlStr = urlGetBase + "api_key=" + apiKey + "&text=" + encodeStr + "&pattern=" + pattern + "&format="
				+ format;
	 ...
	 * "relate": "SBV", "semparent": 1, "semrelate": "Aft", "arg": [] }, { "id":
	 * 1, "cont": "爱", "pos": "v", "ne": "O", "parent": -1, "relate": "HED",
	 * "semparent": -1, "semrelate": "Root", "arg": [ { "id": 0, "type": "A0",
	 * "beg": 0, "end": 0 }, { "id": 1, "type": "A1", "beg": 2, "end": 3 } ] },
	 * { "id": 2, "cont": "北京", "pos": "ns", "ne": "B-Ns", "parent": 3,
	 * "relate": "ATT", "semparent": 3, "semrelate": "Nmod", "arg": [] }, {
	 * "id": 3, "cont": "天安门", "pos": "ns", "ne": "E-Ns", "parent": 1, "relate":
	 * "VOB", "semparent": 1, "semrelate": "Cont", "arg": [] } ] ] ]
	 */
